...
```
sudo apt install awesome fonts-roboto rofi compton i3lock xclip qt5-style-plugins materia-gtk-theme lxappearance xbacklight flameshot nautilus xfce4-power-manager pnmixer network-manager-gnome policykit-1-gnome wget-y
...
```
paru -S awesome rofi picom i3lock-fancy xclip ttf-roboto polkit-gnome materia-theme lxappearance flameshot volumeicon network-manager-applet xfce4-power-manager qt5-styleplugins feh light  papirus-icon-theme xfce4-clipman-plugin glibc  exa sxiv -y
```
...
cd light
sudo cp -v 90-backlight.rules  /usr/lib/udev/rules.d/90-backlight.rules
